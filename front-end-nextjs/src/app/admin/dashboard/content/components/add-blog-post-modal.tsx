...
type AddBlogPostFormValues = z.infer<typeof addBlogPostSchema>
...
export function AddBlogPostModal({ isOpen, onClose, onAdd, categories }: AddBlogPostModalProps) {
  const form = useForm<AddBlogPostFormValues>({
  ...
  function handleSubmit(values: AddBlogPostFormValues) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Điền thông tin để tạo bài viết mới</DialogDescription>
        </DialogHeader>
        <Form {...form}>
