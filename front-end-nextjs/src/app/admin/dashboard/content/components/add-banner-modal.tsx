...
type AddBannerFormValues = z.infer<typeof addBannerSchema>
...
export function AddBannerModal({ isOpen, onClose, onAdd }: AddBannerModalProps) {
  ...
  function handleSubmit(values: AddBannerFormValues) {
    const now = new Date()
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Điền thông tin để tạo banner mới</DialogDescription>
        </DialogHeader>
        <Form {...form}>
