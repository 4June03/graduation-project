...
export default function ProductDetailPage({
  ...
  useEffect(() => {
    async function loadProduct() {
      ...
      try {
        ...
        // Sử dụng dữ liệu mẫu từ JSON mà người dùng cung cấp
        const mockData = {
          bikeId: 1,
              ...
              variantColors: [
                {
                  ...
                  images: [
                    {
                      imageUrl:
                        "/placeholder.svg?height=600&width=600&text=Red+1",
                    },
                    {
                      imageUrl:
                        "/placeholder.svg?height=600&width=600&text=Red+2",
                    },
                    {
                      imageUrl:
                        "/placeholder.svg?height=600&width=600&text=Red+3",
                    },
                  ],
                },
                {
  ...
  const handleAddToCart = async () => {
    ...
    // Dữ liệu gửi lên API theo yêu cầu của người dùng
    const cartData = {
  ...
  const galleryImages = selectedColor.images.map((img: any, index: any) => ({
    id: `${index}`,
    url: img.imageUrl,
